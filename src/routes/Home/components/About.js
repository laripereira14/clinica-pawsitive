import DogImg from 'assets/images/1.png';
...
const About = () => {
    return (
        <section id="about" className="bg-white py-8 px-16 flex flex-col justify-center items-center md:inline-block md:px-20 md:py-12 lg:px-28">
            ...
            <img src={DogImg} alt="dog" className="hidden md:inline-block md:w-5/12 md:float-left md:[shape-outside:url(assets/images/1.png)] md:[shape-margin:1rem] lg:[shape-margin:2rem] lg:w-4/12"/>
