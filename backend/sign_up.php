<?php
    ...
    if (!in_array(null, $_POST)) {
        ...
        $sql = "INSERT INTO clientes (carteirinha, nome, celular, email, nome_pet, especie_pet, data_nasc, senha) 
                VALUES  ('$carteirinha', '$nome', '$celular', '$email', '$nome_pet', '$especie_pet', '$data_nasc', '$senha')";
